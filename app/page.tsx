...
export default function Home() {
  return (
    <main className="overflow-y-scroll snap-y snap-mandatory min-h-[calc(100vh-70px)] h-screen">
      ...
      <section className="snap-start min-h-screen flex flex-col items-center justify-center px-4 pt-12 pb-8 animate-fade-in">
        <div className="w-full max-w-3xl text-center">
          ...
          <p className="text-lg md:text-xl text-white/70 mb-8 max-w-xl mx-auto">
            I build modern, scalable web applications using MongoDB, Express,
            React, and Node.js. Passionate about clean code,improve backend
            system, and seamless user experiences.
          </p>
          <Link
            href="https://www.canva.com/design/DAGtnn2dREM/UujrEjRkkNXTAh63e6OQbw/edit"
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-17  justify-center">
            ...
            <div className="bg-white/10 col-span-5 backdrop-blur-md rounded-3xl shadow-2xl p-6 flex flex-col items-center  transition-transform duration-300 hover:scale-105 hover:shadow-2xl animate-slide-up w-full min-w-[400px] min-h-[480px]">
              <div className="w-full  h-64 bg-gradient-to-tr from-blue-500 via-cyan-400 to-teal-400 rounded-2xl mb-6 overflow-hidden flex items-center justify-center">
                <Image
                  src="/assets/ytImage.png"
                  alt="Project 1"
                  className=" w-full h-full rounded-2xl opacity-90 hover:opacity-100 transition-opacity duration-300 "
                  width={800}
                  height={400}
                />
              </div>
              ...
              <p className="text-white/70 text-center text-lg">
                Implemented complex and optimized database queries. User can do
                watch , like, subscribe the channel and so on.{" "}
              </p>
              <div className="flex items-center gap-1 mt-2 underline">
                <Pointer style={{ transform: "rotate(90deg)" }} />
                <Link
                  href="https://github.com/dvansari65/mini-youtube-"
            ...
            <div className="bg-white/10 col-span-5 backdrop-blur-md rounded-3xl shadow-2xl p-6 flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-2xl animate-slide-up w-full min-w-[400px] min-h-[480px]">
              ...
              <p className="text-white/70 text-center text-lg">
                Integrated Stripe payment system for seamless and secure
                payments
              </p>
              <div className="flex items-center gap-1 mt-2 underline">
                <Pointer style={{ transform: "rotate(90deg)" }} />
                <Link
                  href="https://github.com/dvansari65/shopit-ecommerce-platform"
                  className="text-black mt-1"
                >
                  Github Repo
                </Link>
            ...
            <div className="bg-white/10 col-span-5 backdrop-blur-md rounded-3xl shadow-2xl p-6 flex flex-col items-center transition-transform duration-300 hover:scale-105 hover:shadow-2xl animate-slide-up w-full min-w-[400px] min-h-[480px]">
              <div className="w-full h-64 bg-gradient-to-tr from-blue-500 via-cyan-400 to-teal-400 rounded-2xl mb-6 overflow-hidden flex items-center justify-center">
                <Image
                  src="/assets/Real-time-ChatApp.png"
                  alt="Project 3"
                  className=" w-full h-full rounded-2xl opacity-90 hover:opacity-100 transition-opacity duration-300"
                  width={800}
                  height={400}
              ...
              <p className="text-white/70 text-center text-lg">
                Real time chat app build with best practices and written in
                clean , maitainable code!
              </p>
              <div className="flex items-center gap-1 mt-2 underline">
                <Pointer style={{ transform: "rotate(90deg)" }} />
                <Link
                  href="https://github.com/dvansari65/real-time-chatApp"
                  className="text-black mt-1"
                >
                  Github Repo
                </Link>
        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-xl px-6 py-4 flex flex-col items-center shadow-md min-w-[120px]">
              ...
              <span className="mt-2 font-semibold text-white">Next.js</span>
            </div>
            <div className="bg-white/10 backdrop-blur-md rounded-xl px-6 py-4 flex flex-col items-center shadow-md min-w-[120px]">
              <img src={"/assets/prisma.svg"} className="size-10"/>
              <span className="mt-2 font-semibold text-white">Prisma</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="snap-start min-h-screen flex flex-col items-center justify-center px-4 pt-12 pb-8 animate-fade-in">
        <div className="w-full max-w-2xl bg-white/10 backdrop-blur-md rounded-2xl shadow-xl p-8 flex flex-col items-center border border-white/10">
          ...
          <h2 className="text-lg text-white/80 mb-2">
            Third Year CS Student & MERN Stack Developer
          </h2>
          <p className="text-center text-white/70 max-w-md">
            Started my coding journey on{" "}
            <span className="font-semibold text-cyan-300">14 March</span>. Since
            then, I've been passionate about building, learning, and growing
            every day. I love turning ideas into reality with code and exploring
            new technologies.
          </p>
        </div>
      </section>
          ...
          <ol className="relative border-l-2 border-cyan-400 ml-4">
            <li className="mb-10 ml-6">
              ...
              <p className="text-white/70">
                Started my coding journey, diving into the world of programming
                and web development.
              </p>
            </li>
            <li className="mb-10 ml-6">
              ...
              <h4 className="text-lg font-semibold text-white">
                march to april - Frontend
              </h4>
              <p className="text-white/70">
                Learned HTML, CSS, JavaScript, and mastered modern frontend
                frameworks like React. Built beautiful and responsive user
                interfaces.
              </p>
            </li>
            <li className="mb-10 ml-6">
              ...
              <p className="text-white/70">
                Explored backend development with Node.js and Express, built
                robust APIs, and worked with databases like MongoDB.
              </p>
            </li>
            <li className="mb-10 ml-6">
              ...
              <p className="text-white/70">
                Discovered Docker and containerization, learned to deploy and
        ...
        <div className="w-full max-w-4xl">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <div className="bg-white/10 backdrop-blur-md rounded-xl px-6 py-4 flex flex-col items-center shadow-md min-w-[160px]">
              ...
              <span className="text-white/70 text-center mt-1">
                Always eager to learn new things and explore new tech.
              </span>
            </div>
            <div className="bg-white/10 backdrop-blur-md rounded-xl px-6 py-4 flex flex-col items-center shadow-md min-w-[160px]">
              <span className="text-2xl mb-2">💡</span>
              ...
              <span className="text-white/70 text-center mt-1">
                Love to solve problems and build beautiful, functional apps.
              </span>
            </div>
            <div className="bg-white/10 backdrop-blur-md rounded-xl px-6 py-4 flex flex-col items-center shadow-md min-w-[160px]">
              <span className="text-2xl mb-2">🤝</span>
              ...
              <span className="text-white/70 text-center mt-1">
                Enjoy working with others and contributing to open source.
              </span>
            </div>
            <div className="bg-white/10 backdrop-blur-md rounded-xl px-6 py-4 flex flex-col items-center shadow-md min-w-[160px]">
              <span className="text-2xl mb-2">🌱</span>
      ...
      <section
        id="connect"
        className="snap-start min-h-screen flex flex-col items-center justify-center px-4 pt-12 pb-8 animate-slide-up"
      >
      ...
      <section className="snap-start min-h-screen flex flex-col items-center justify-center px-4 pt-12 pb-8 animate-fade-in">
        <div className="w-full max-w-2xl text-center">
          <blockquote className="text-xl italic text-cyan-200 mb-2">
